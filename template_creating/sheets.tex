...
\begin{tikzpicture}[scale=2][H]
    ...
    % \hspace{-14em}   
        ...
        \node[draw=none,fill=none] {\qrcode[height=\missingcommand{boxWidth}mm]{\the\value{symIndex}} }; \pgfmatrixnextcell
        }
        
        % \hspace{-14em}
        % manually print last qr code to close without \pgfmatrixnextcell
        \node[draw=none,fill=none] {\qrcode[height=\missingcommand{boxWidth}mm]{\the\value{symIndex}} };\\
    };
\end{tikzpicture}
