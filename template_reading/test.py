...
class TestStringMethods(unittest.TestCase):
    ...
    def test_not_qr_in_each_row(self):
        ...
        qr_one = QrCode(2,1,2,3,4,self.read.nrOfSymbols,self.read.nrOfBoxesPerLine,self.read.nrOfLinesPerPage)
        qr_two = QrCode(18,1,2,3,4,self.read.nrOfSymbols,self.read.nrOfBoxesPerLine,self.read.nrOfLinesPerPage)
        #qr_three = QrCode(23,1,2,3,4,self.read.nrOfSymbols,self.read.nrOfBoxesPerLine,self.read.nrOfLinesPerPage)
    ...
    def test_most_left_colum(self):
        ...
        qr_three = QrCode(8,1,2,3,4,self.read.nrOfSymbols,self.read.nrOfBoxesPerLine,self.read.nrOfLinesPerPage)
        qrcodes = [qr_one,qr_two,qr_three]
    ...
    def test_has_quarter_spacing_false(self):
        ...
        qr_one = QrCode(3,1,2,3,4,self.read.nrOfSymbols,self.read.nrOfBoxesPerLine,self.read.nrOfLinesPerPage)
        qr_two = QrCode(5,1,2,3,4,self.read.nrOfSymbols,self.read.nrOfBoxesPerLine,self.read.nrOfLinesPerPage)
        qr_three = QrCode(18,1,2,3,4,self.read.nrOfSymbols,self.read.nrOfBoxesPerLine,self.read.nrOfLinesPerPage)
        qrcodes = [qr_one,qr_two,qr_three]
    ...
    def test_has_quarter_spacing_false_but_close(self):
        ...
        qr_one = QrCode(3,1,2,3,4,self.read.nrOfSymbols,self.read.nrOfBoxesPerLine,self.read.nrOfLinesPerPage)
        qr_two = QrCode(5,1,2,3,4,self.read.nrOfSymbols,self.read.nrOfBoxesPerLine,self.read.nrOfLinesPerPage)
        qr_three = QrCode(6,1,2,3,4,self.read.nrOfSymbols,self.read.nrOfBoxesPerLine,self.read.nrOfLinesPerPage)
        qrcodes = [qr_one,qr_two,qr_three]
        self.assertFalse(self.read.has_quarter_spacing(qrcodes))    
    ...
    def test_avg_qr_width_per_row(self):
        ...
        width_two = 10
        width_three = 20
        qr_one = QrCode(3,1,2,width_one,4,self.read.nrOfSymbols,self.read.nrOfBoxesPerLine,self.read.nrOfLinesPerPage)
        qr_two = QrCode(5,1,2,width_two,4,self.read.nrOfSymbols,self.read.nrOfBoxesPerLine,self.read.nrOfLinesPerPage)
